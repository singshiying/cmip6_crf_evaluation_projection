#取出24个模式ssp585实验2015-2100的area mean平均年平均的toa sw,toa lw,sfc sw,sfc lw,clt五个变量的时间序列
#取出24个模式历史实验1995-2014的area mean年平均的toa sw,toa lw,sfc sw,sfc lw,clt五个变量的时间序列
#取出24个模式ssp245的1995-2100的area mean年平均的toa sw,toa lw,sfc sw,sfc lw,clt五个变量的时间序列
import os
import numpy as np
import xarray as xr
import glob
...
def cal_my_his(num):
    ...
    if num==0 or num==1:
        ...
        rsutcs=xr.open_dataset(cas_path)['rsutcs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsut/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rsut=xr.open_dataset(cas_path)['rsut'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]
        ...
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rlutcs=xr.open_dataset(cas_path)['rlutcs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rlut/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rlut=xr.open_dataset(cas_path)['rlut'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
        lw_crf=rlutcs-rlut
        # print(lw_crf)
        ...
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rsus=xr.open_dataset(cas_path)['rsus'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsds/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rsds=xr.open_dataset(cas_path)['rsds'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsdscs/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rsdscs=xr.open_dataset(cas_path)['rsdscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsuscs/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rsuscs=xr.open_dataset(cas_path)['rsuscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
        ...
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rldscs=xr.open_dataset(cas_path)['rldscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rlds/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rlds=xr.open_dataset(cas_path)['rlds'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
        ...
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        clt=xr.open_dataset(cas_path)['clt'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
        ...
        for m in range(len(models)):
            if m!=5:
                ...
                rsutcs=xr.open_dataset(fhis)['rsutcs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
                fhis=glob.glob(model_his+models[m]+'/rsut_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rsut=xr.open_dataset(fhis)['rsut'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
                sw_crf=rsutcs-rsut
                ...
                rlutcs=xr.open_dataset(fhis)['rlutcs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
                fhis=glob.glob(model_his+models[m]+'/rlut_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rlut=xr.open_dataset(fhis)['rlut'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
                lw_crf=rlutcs-rlut
                # print(lw_crf)
                weights2=np.cos(np.deg2rad(lw_crf.coords['lat']))
                lw_crf_weighted=lw_crf.weighted(weights2)
                ...
                rsds=xr.open_dataset(fhis)['rsds'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
                fhis=glob.glob(model_his+models[m]+'/rsus_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rsus=xr.open_dataset(fhis)['rsus'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
                fhis=glob.glob(model_his+models[m]+'/rsuscs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rsuscs=xr.open_dataset(fhis)['rsuscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
                fhis=glob.glob(model_his+models[m]+'/rsdscs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rsdscs=xr.open_dataset(fhis)['rsdscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
                sfc_sw_crf=rsds-rsus-rsdscs+rsuscs
                sfc_sw_crf_weighted=sfc_sw_crf.weighted(weights2)
                sfc_sw_crf_weighted_mean=sfc_sw_crf_weighted.mean(('lon','lat'))
                #annual_lw_crf=lw_crf_weighted_mean.groupby('time.season').mean()
                ...
                rlds=xr.open_dataset(fhis)['rlds'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
                fhis=glob.glob(model_his+models[m]+'/rldscs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rldscs=xr.open_dataset(fhis)['rldscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
                sfc_lw_crf=rlds-rldscs
                sfc_lw_crf_weighted=sfc_lw_crf.weighted(weights2)
                sfc_lw_crf_weighted_mean=sfc_lw_crf_weighted.mean(('lon','lat'))
                #annual_lw_crf=lw_crf_weighted_mean.groupby('time.season').mean()
                ...
                if m==7:
                    # print('CIESM')
                    clt=xr.open_dataset(fhis)['clt'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]*100 #240x48x192
                else:
                    clt=xr.open_dataset(fhis)['clt'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
                weights=np.cos(np.deg2rad(clt.coords['lat']))
                clt_weighted=clt.weighted(weights)
                clt_weighted_mean=clt_weighted.mean(('lon','lat'))
                #annual_clt=clt_weighted_mean.groupby('time.season').mean()
        ...
        area_my=re.findall(pattern,area[num])
        rsutcs=xr.open_dataset(cas_path)['rsutcs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]
        rsutcs2=xr.open_dataset(cas_path)['rsutcs'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360]
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsut/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rsut=xr.open_dataset(cas_path)['rsut'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]
        rsut2=xr.open_dataset(cas_path)['rsut'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):int(area_my[0]),0:360]
        sw_crf=rsutcs-rsut#短波云辐射强迫
        ...
        cas_path=cas_path+os.listdir(cas_path)[0]
        rlutcs=xr.open_dataset(cas_path)['rlutcs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
        rlutcs2=xr.open_dataset(cas_path)['rlutcs'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] #240x48x192
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rlut/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rlut=xr.open_dataset(cas_path)['rlut'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
        rlut2=xr.open_dataset(cas_path)['rlut'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] 
        lw_crf=rlutcs-rlut
        ...
        cas_path=cas_path+os.listdir(cas_path)[0]
        rsus=xr.open_dataset(cas_path)['rsus'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
        rsus2=xr.open_dataset(cas_path)['rsus'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] #240x48x192
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsds/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rsds=xr.open_dataset(cas_path)['rsds'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
        rsds2=xr.open_dataset(cas_path)['rsds'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] 
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsdscs/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rsdscs=xr.open_dataset(cas_path)['rsdscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
        rsdscs2=xr.open_dataset(cas_path)['rsdscs'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] #240x48x192
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsuscs/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rsuscs=xr.open_dataset(cas_path)['rsuscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]
        rsuscs2=xr.open_dataset(cas_path)['rsuscs'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360]  
        sfc_sw_crf=rsds-rsus-rsdscs+rsuscs
        ...
        cas_path=cas_path+os.listdir(cas_path)[0]
        rldscs=xr.open_dataset(cas_path)['rldscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
        rldscs2=xr.open_dataset(cas_path)['rldscs'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] #240x48x192
        cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rlds/'
        cas_path=cas_his+os.listdir(cas_his)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]+'/'
        cas_path=cas_path+os.listdir(cas_path)[0]
        rlds=xr.open_dataset(cas_path)['rlds'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
        rlds2=xr.open_dataset(cas_path)['rlds'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] 
        sfc_lw_crf=rlds-rldscs
        ...
        cas_path=cas_path+os.listdir(cas_path)[0]
        clt=xr.open_dataset(cas_path)['clt'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
        clt2=xr.open_dataset(cas_path)['clt'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] #240x48x192
        weights=np.cos(np.deg2rad(clt.coords['lat']))
        ...
        for m in range(len(models)):
            if m!=5:
                ...
                fhis=glob.glob(model_his+models[m]+'/rsutcs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rsutcs=xr.open_dataset(fhis)['rsutcs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
                rsutcs2=xr.open_dataset(fhis)['rsutcs'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] #240x48x192
                fhis=glob.glob(model_his+models[m]+'/rsut_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rsut=xr.open_dataset(fhis)['rsut'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]
                rsut2=xr.open_dataset(fhis)['rsut'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360]  
                sw_crf=rsutcs-rsut
                sw_crf2=rsutcs2-rsut2
                #将短波辐射云强迫都矫正为太阳直射时的swcrf，以去除太阳入射角度对swcrf的影响，全部除以cos（lat）
                # weights=np.cos(np.deg2rad(sw_crf.coords['lat']))
                ...
                fhis=glob.glob(model_his+models[m]+'/rlutcs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rlutcs=xr.open_dataset(fhis)['rlutcs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
                rlutcs2=xr.open_dataset(fhis)['rlutcs'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] #240x48x192
                fhis=glob.glob(model_his+models[m]+'/rlut_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rlut=xr.open_dataset(fhis)['rlut'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
                rlut2=xr.open_dataset(fhis)['rlut'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] 
                lw_crf=rlutcs-rlut
                lw_crf2=rlutcs2-rlut2
                # print(lw_crf)
                weights2=np.cos(np.deg2rad(lw_crf.coords['lat']))
                ...
                #求sfc sw cre
                fhis=glob.glob(model_his+models[m]+'/rsds_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rsds=xr.open_dataset(fhis)['rsds'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]
                rsds2=xr.open_dataset(fhis)['rsds'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] #240x48x192
                fhis=glob.glob(model_his+models[m]+'/rsus_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rsus=xr.open_dataset(fhis)['rsus'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
                rsus2=xr.open_dataset(fhis)['rsus'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360]
                fhis=glob.glob(model_his+models[m]+'/rsuscs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rsuscs=xr.open_dataset(fhis)['rsuscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] #240x48x192
                rsuscs2=xr.open_dataset(fhis)['rsuscs'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] 
                fhis=glob.glob(model_his+models[m]+'/rsdscs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rsdscs=xr.open_dataset(fhis)['rsdscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]
                rsdscs2=xr.open_dataset(fhis)['rsdscs'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] 
                sfc_sw_crf=rsds-rsus-rsdscs+rsuscs
                sfc_sw_crf2=rsds2-rsus2-rsdscs2+rsuscs2
                sfc_sw_crf_weighted=sfc_sw_crf.weighted(weights2)
                sfc_sw_crf_weighted2=sfc_sw_crf2.weighted(weights22)
                ...
                #求sfc lw cre
                fhis=glob.glob(model_his+models[m]+'/rlds_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rlds=xr.open_dataset(fhis)['rlds'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
                rlds2=xr.open_dataset(fhis)['rlds'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] #240x48x192
                fhis=glob.glob(model_his+models[m]+'/rldscs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
                rldscs=xr.open_dataset(fhis)['rldscs'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360] 
                rldscs2=xr.open_dataset(fhis)['rldscs'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] 
                sfc_lw_crf=rlds-rldscs
                sfc_lw_crf2=rlds2-rldscs2
                sfc_lw_crf_weighted=sfc_lw_crf.weighted(weights2)
                sfc_lw_crf_weighted2=sfc_lw_crf2.weighted(weights22)
                ...
                if m==7:
                    # print('CIESM')
                    clt=xr.open_dataset(fhis)['clt'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]*100 
                    clt2=xr.open_dataset(fhis)['clt'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360]*100 #240x48x192
                else:
                    clt=xr.open_dataset(fhis)['clt'].loc['1850-01-01':'2014-12-30',int(area_my[0]):int(area_my[1]),0:360]
                    clt2=xr.open_dataset(fhis)['clt'].loc['1850-01-01':'2014-12-30',-int(area_my[1]):-int(area_my[0]),0:360] #240x48x192
                weights=np.cos(np.deg2rad(clt.coords['lat']))
                weightss=np.cos(np.deg2rad(clt2.coords['lat']))
                clt_weighted=clt.weighted(weights)
                clt_weighted2=clt2.weighted(weightss)
...
# final_out=np.zeros((len(area),5,240+1020,len(models)))
final_out1=np.zeros((len(area),5,1980,len(models)))
final_out2=np.zeros((len(area),5,1020,len(models)))
final_out3=np.zeros((len(area),5,1020,len(models)))
for i in range(len(area)):
    print(area[i])
    final_out1[i,:,:,:]=cal_my_his(i)
    final_out2[i,:,:,:]=cal_my_ssp245(i)
    final_out3[i,:,:,:]=cal_my_ssp585(i)
da = os.path.exists('fig7_1.npy')
if da:
    os.remove('fig7_1.npy')
    os.remove('fig7_2.npy')
    os.remove('fig7_3.npy')
np.save('fig7_1.npy',final_out1)
np.save('fig7_2.npy',final_out2)
np.save('fig7_3.npy',final_out3)
print(final_out1.shape,'file save')