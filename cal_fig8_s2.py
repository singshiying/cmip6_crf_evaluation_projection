#计算historical的1995-2014这20年的平均
#全部插值到1x1 like obs 360x180
import os
import numpy as np
import xarray as xr
import glob
...
data_out=np.zeros((5,180,360,len(models)))#toa cre,sfc cre,clt;models+cas+obs
...
cas_path=cas_path+os.listdir(cas_path)[0]
rsut=xr.open_dataset(cas_path)['rsut'].loc['1995-01-01':'2014-12-30',-90:90,0:360]
cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsutcs/'
cas_path=cas_his+os.listdir(cas_his)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]
rsutcs=xr.open_dataset(cas_path)['rsutcs'].loc['1995-01-01':'2014-12-30',-90:90,0:360]
sw_crf=rsutcs-rsut
...
cas_path=cas_path+os.listdir(cas_path)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]
rlutcs=xr.open_dataset(cas_path)['rlutcs'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rlut/'
cas_path=cas_his+os.listdir(cas_his)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]
rlut=xr.open_dataset(cas_path)['rlut'].loc['1995-01-01':'2014-12-30',-90:90,0:360] 
lw_crf=rlutcs-rlut
...
cas_path=cas_path+os.listdir(cas_path)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]
rsus=xr.open_dataset(cas_path)['rsus'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsds/'
cas_path=cas_his+os.listdir(cas_his)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]
rsds=xr.open_dataset(cas_path)['rsds'].loc['1995-01-01':'2014-12-30',-90:90,0:360] 
cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsdscs/'
cas_path=cas_his+os.listdir(cas_his)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]
rsdscs=xr.open_dataset(cas_path)['rsdscs'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rsuscs/'
cas_path=cas_his+os.listdir(cas_his)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]
rsuscs=xr.open_dataset(cas_path)['rsuscs'].loc['1995-01-01':'2014-12-30',-90:90,0:360] 
...
cas_path=cas_path+os.listdir(cas_path)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]
rldscs=xr.open_dataset(cas_path)['rldscs'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
cas_his='/data03/cmip6/post-new/CMIP6/CMIP6/CMIP/CAS/CAS-ESM2-0/historical/r1i1p1f1/Amon/rlds/'
cas_path=cas_his+os.listdir(cas_his)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]
rlds=xr.open_dataset(cas_path)['rlds'].loc['1995-01-01':'2014-12-30',-90:90,0:360] 
...
cas_path=cas_path+os.listdir(cas_path)[0]+'/'
cas_path=cas_path+os.listdir(cas_path)[0]
clt=xr.open_dataset(cas_path)['clt'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
...
for m in range(len(models)):
    if m!=4:
        ...
        rsutcs=xr.open_dataset(fhis)['rsutcs'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
        fhis=glob.glob(model_his+models[m]+'/rsut_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
        rsut=xr.open_dataset(fhis)['rsut'].loc['1995-01-01':'2014-12-30',-90:90,0:360] 
        sw_crf=rsutcs-rsut
        sw_crf=sw_crf.interp(lat=olat,lon=olon,kwargs={'fill_value': 'extrapolate'})
        sw_crf.data=sw_crf.data/time_lat_lon_weight
        ...
        rlutcs=xr.open_dataset(fhis)['rlutcs'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
        fhis=glob.glob(model_his+models[m]+'/rlut_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
        rlut=xr.open_dataset(fhis)['rlut'].loc['1995-01-01':'2014-12-30',-90:90,0:360] 
        lw_crf=rlutcs-rlut
        lw_crf=lw_crf.interp(lat=olat,lon=olon,kwargs={'fill_value': 'extrapolate'})
        ...
        rsds=xr.open_dataset(fhis)['rsds'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
        fhis=glob.glob(model_his+models[m]+'/rsus_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
        rsus=xr.open_dataset(fhis)['rsus'].loc['1995-01-01':'2014-12-30',-90:90,0:360] 
        fhis=glob.glob(model_his+models[m]+'/rsuscs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
        rsuscs=xr.open_dataset(fhis)['rsuscs'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
        fhis=glob.glob(model_his+models[m]+'/rsdscs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
        rsdscs=xr.open_dataset(fhis)['rsdscs'].loc['1995-01-01':'2014-12-30',-90:90,0:360] 
        sfc_sw_crf=rsds-rsus-rsdscs+rsuscs
        sfc_sw_crf=sfc_sw_crf.interp(lat=olat,lon=olon,kwargs={'fill_value': 'extrapolate'})
        ...
        rlds=xr.open_dataset(fhis)['rlds'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
        fhis=glob.glob(model_his+models[m]+'/rldscs_Amon_'+models[m]+'_historical_r1i1p1f1'+'*185001-201412.nc')[0]
        rldscs=xr.open_dataset(fhis)['rldscs'].loc['1995-01-01':'2014-12-30',-90:90,0:360] 
        sfc_lw_crf=rlds-rldscs
        sfc_lw_crf=sfc_lw_crf.interp(lat=olat,lon=olon,kwargs={'fill_value': 'extrapolate'})
        ...
        clt=xr.open_dataset(fhis)['clt'].loc['1995-01-01':'2014-12-30',-90:90,0:360] #240x48x192
        clt=clt.interp(lat=olat,lon=olon,kwargs={'fill_value': 'extrapolate'})
...
da = os.path.exists('fig8_s2.npy')
if da:
    os.remove('fig8_s2.npy')

print(data_out.shape)
np.save('fig8_s2.npy',data_out)