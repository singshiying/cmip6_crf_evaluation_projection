...
###############读取气候态
data_out=np.load('../fig1.npy').reshape(5,180*360,21,order='A')#20models+obs
###################读取SVI AVI
...
csr_rank_xr.to_netcdf('../data/csr_vi_rank_score_21x35.nc')
...
ax.text(3.5, 26.5-4,"TOA SWCRE",ha='center',va='center',fontsize=16,rotation=0)
ax.text(10.5, 26.5-4,"TOA LWCRE",ha='center',va='center',fontsize=16,rotation=0)
ax.text(17.5, 26.5-4,"SFC SWCRE",ha='center',va='center',fontsize=16,rotation=0)
ax.text(24.5, 26.5-4,"SFC LWCRE",ha='center',va='center',fontsize=16,rotation=0)
...
plt.savefig('../fig/heatmap_model_score.png',bbox_inches='tight')
