...
data_out=np.load('/data04/shiy/code_cloud/code_paper_7.13/code2/fig1.npy').reshape(5,180*360,21,order='A')#5var,180lat,360lon,21models+obs
...
plt.savefig('../fig//taylor_diagram.pdf',bbox_inches='tight')