...
data_out2=np.load('/data04/shiy/code_cloud/code_paper_7.13/code2/fig4_s2_v2_add.npy')#3x180x360x21  sVI指数
...
data_out3=np.load('/data04/shiy/code_cloud/code_paper_7.13/code2/fig4_s3_v2_add.npy')#53x180x360x21  aVI指数
...
# 创建图形
width_cm = 15
height_cm = 15  # 保持原高度比例
fig = plt.figure(figsize=(width_cm / 2.54, height_cm / 2.54), dpi=600)
...
plt.savefig('../fig/bwmme_svi_avi_revi.pdf', bbox_inches='tight')