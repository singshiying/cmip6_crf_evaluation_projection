...
###############读取气候态
data_out=np.load('../data/fig1_modis.npy')#.reshape(5,180*360,21,order='A')
#20models+obs
###################读取SVI AVI
season1=np.load('../data/fig4_s2_v2_modis.npy')#.reshape(5,180*360,21,order='A')#5var,latxlon,20model+AMMME
annual1=np.load('../data/fig4_s3_v2_modis.npy')#.reshape(5,180*360,21,order='A')
...
csr_rank_xr.to_netcdf('../data/csr_vi_rank_score_21x35_60NS_modis.nc')