...
c1=drawc(fig,axes[0][0],1,'(a) Annual VI of TOA SWCRF',clev,np.mean(annual[0,:,:,0:20],2))
c2=drawc(fig,axes[0][1],2,'(b) Seasonal VI of TOA SWCRF ',clev,season[0,:,:,20])
c3=drawc(fig,axes[1][0],3,'(c) Annual VI of TOA LWCRF',clev,np.mean(annual[0,:,:,0:20],2))
c4=drawc(fig,axes[1][1],4,'(d) Seasonal VI of TOA LWCRF',clev,season[1,:,:,20])
c5=drawc(fig,axes[2][0],5,'(e) Annual VI of SFC SWCRF',clev,np.mean(annual[0,:,:,0:20],2))
c6=drawc(fig,axes[2][1],6,'(f) Seasonal VI of SFC SWCRF',clev,season[2,:,:,20])
c7=drawc(fig,axes[3][0],7,'(g) Annual VI of SFC LWCRF',clev,np.mean(annual[0,:,:,0:20],2))
c8=drawc(fig,axes[3][1],8,'(h) Seasonal VI of SFC LWCRF',clev,season[3,:,:,20])
...
plt.savefig('../fig/vi_map.svg',bbox_inches='tight')