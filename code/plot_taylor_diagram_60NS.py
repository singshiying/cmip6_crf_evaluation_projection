...
for m in np.arange(0,20):
    ...
    d4 = plot_taylor(ax1,data_out2[2,:,20],data_out2[2,:,m], m,color='darkblue',marker='o',alpha=0.8,markersize=3*2,markeredgewidth=2,label=models[m])
    d5 = plot_taylor(ax1,data_out2[3,:,20],data_out2[3,:,m], m,color='darkred',marker='o',alpha=0.8,markersize=3*2,markeredgewidth=2,label=models[m])
...
d11 = plot_taylor(ax1,data_out2[2,:,20],np.mean(data_out2[2,:,0:20],1), 24,color='darkblue',marker='v',markeredgecolor='k',markeredgewidth=2,alpha=0.7,markersize=7*2,zorder=50)
d12 = plot_taylor(ax1,data_out2[3,:,20],np.mean(data_out2[3,:,0:20],1), 24,color='darkred',marker='v',markeredgecolor='k',markeredgewidth=2,alpha=0.7,markersize=7*2,zorder=50)
...
ax1.text(0.85,0.83,'SFC SWCRF',color='darkblue',transform=ax1.transAxes,fontsize=9*2)
ax1.text(0.85,0.77,'SFC LWCRF',color='darkred',transform=ax1.transAxes,fontsize=9*2)
ax1.text(0.85,0.71,'CLT',color='g',transform=ax1.transAxes,fontsize=9*2)

plt.savefig('../fig/taylor_diagram.svg',bbox_inches='tight')