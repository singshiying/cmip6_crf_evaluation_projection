...
csri=np.zeros((21,5,5))#5varx4metircsx24model+AMME
for v in range(5):
    csri[:,v,3]=annual[v,:]
    csri[:,v,4]=season[v,:]
    for m in range(21):
...
# print('------')
# index1=np.argsort(bm_wm[:,0]+bm_wm[:,1])
# models_p=models
# models_p=np.array(models)[index1]
# print(models_p)
# print('------')
# index1=np.argsort(bm_wm[:,2]+bm_wm[:,3])
# models_p=models
# models_p=np.array(models)[index1]
# print(models_p)
# print('------')
# print('------')
# index1=np.argsort(bm_wm[:,4])
# models_p=models
# models_p=np.array(models)[index1]
# print(models_p)
# print('------')
...
# ------
# 0
# ['FGOALS-g3' 'MRI-ESM2-0' 'ACCESS-ESM1-5' 'NESM3' 'INM-CM5-0' 'INM-CM4-8'
#  'CAS-ESM2-0' 'MIROC6' 'GFDL-ESM4' 'MPI-ESM1-2-LR' 'BCC-CSM2-MR'
#  'MPI-ESM1-2-HR' 'IPSL-CM6A-LR' 'KIOST-ESM' 'AMME' 'CanESM5' 'KACE-1-0-G'
#  'EC-Earth3-CC' 'CMCC-CM2-SR5' 'CESM2-WACCM' 'ACCESS-CM2']
# ------
# 1
# ['CAS-ESM2-0' 'KIOST-ESM' 'FGOALS-g3' 'EC-Earth3-CC' 'NESM3' 'INM-CM4-8'
#  'INM-CM5-0' 'IPSL-CM6A-LR' 'AMME' 'CanESM5' 'CMCC-CM2-SR5' 'ACCESS-CM2'
#  'KACE-1-0-G' 'MPI-ESM1-2-LR' 'MIROC6' 'MRI-ESM2-0' 'MPI-ESM1-2-HR'
#  'BCC-CSM2-MR' 'CESM2-WACCM' 'GFDL-ESM4' 'ACCESS-ESM1-5']
# ------
# 2
# ['INM-CM4-8' 'KIOST-ESM' 'CAS-ESM2-0' 'MIROC6' 'IPSL-CM6A-LR' 'FGOALS-g3'
#  'NESM3' 'INM-CM5-0' 'MRI-ESM2-0' 'GFDL-ESM4' 'ACCESS-ESM1-5'
#  'BCC-CSM2-MR' 'MPI-ESM1-2-LR' 'CMCC-CM2-SR5' 'CanESM5' 'EC-Earth3-CC'
#  'CESM2-WACCM' 'AMME' 'MPI-ESM1-2-HR' 'KACE-1-0-G' 'ACCESS-CM2']
# ------
# 3
# ['FGOALS-g3' 'IPSL-CM6A-LR' 'INM-CM4-8' 'CAS-ESM2-0' 'NESM3' 'INM-CM5-0'
#  'ACCESS-CM2' 'KACE-1-0-G' 'EC-Earth3-CC' 'KIOST-ESM' 'CanESM5'
#  'MRI-ESM2-0' 'CMCC-CM2-SR5' 'CESM2-WACCM' 'MIROC6' 'AMME' 'BCC-CSM2-MR'
#  'ACCESS-ESM1-5' 'GFDL-ESM4' 'MPI-ESM1-2-LR' 'MPI-ESM1-2-HR']
# ------
# 4
