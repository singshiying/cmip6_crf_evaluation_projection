#计算sfc and toa 4 varscsrvi rank score
import os
import numpy as np
import xarray as xr
import glob
...
csr_rank_xr=xr.DataArray(csr_rank,coords=[models,np.arange(0,28,1)],dims=['models','4varx7metric'])
csr_rank_xr.to_netcdf('./csr_vi_rank_score_21x28.nc')